...
Shader "Amazing Assets/Curved World/Particles/Lit"
{
    Properties
    {
        [CurvedWorldBendSettings] _CurvedWorldBendSettings("0,3,5|1|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_LITTLEPLANET_Y CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_NEGATIVE
